...
class DatosVisita extends Component
{
    ...
    {
        $comunas = Commune::all();
        return view('livewire.reception.componentes.datos-visita',compact('comunas'));
    }
    ...
    public function search()
    {
        ...
        return view('livewire.reception.componentes.form-visita');
    }
    ...
    public function guardar()
    {
        ...
        if($visita->save())
        {
            ...
            return view('livewire.reception.componentes.form-visita',compact('exito'));
