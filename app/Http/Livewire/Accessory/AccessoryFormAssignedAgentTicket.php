...
class AccessoryFormAssignedAgentTicket extends Component
{
    public $category;
    public $subCategory;
    public $brand;
    ...
    {
        $this->categories = AccessoryCategory::all();
    ...
    public function updatedBranch( $value ): void
    {
    ...
    {
        return $this->subCategories = AccessorySubCategory::where('category_id', $value)->get();
    }
    ...
    public function render()
    {
        ...
        return view('livewire.accesory.accessory-form-assigned-agent-ticket', [
            'brands' => $this->brands,
