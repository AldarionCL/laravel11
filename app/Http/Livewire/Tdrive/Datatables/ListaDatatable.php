...
namespace App\Http\Livewire\Tdrive\Datatables;
...
class ListaDatatable extends DataTableComponent
{
    ...
    {
        $this->setPrimaryKey('TDRIVE_Flujos.ID')
            ->setDefaultSort('TDRIVE_Flujos.created_at', 'desc')
    ...
    {
        $datos = TdriveFlujos::with('Sucursal');
        ...
        return [
            Column::make('Acción','ID')
                ->format(function($value, $column, $row) {
                    return view('livewire.tdrive.datatables.lista-datatable', compact('row','value'));
                }),
            Column::make('Estado','EstadoTdrive')
                ->searchable()->sortable(),
    ...
    public function export()
    {
        ...
        return Excel::download(new VisitasExport($visitas), 'flujosTdrive.xlsx');
    }
}
