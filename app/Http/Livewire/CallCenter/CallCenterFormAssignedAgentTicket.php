...
class CallCenterFormAssignedAgentTicket extends Component
{
    public $category;
    public $subCategory;
    public $brand;
    ...
    {
        $this->categories = CallCenterCategory::all();
    ...
    {
        return $this->subCategories = CallCenterSubCategory::where('category_id', $value)->get();
    }
    ...
    public function render()
    {
        ...
        return view('livewire.call-center.call-center-form-assigned-agent-ticket', [
            'brands' => $this->brands,
