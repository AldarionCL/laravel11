...
class tiemposWip extends Component
{
    public $pasos;
    public $iconos;
    ...
    public function render()
    {
        ...
        $tareasWip = CpdTipos::select('ID')->where('Requerimiento','WIP')->get()->toArray();
        $casos = [];
        $this->pasos = CpdTipos::where('Requerimiento','WIP')->get();
        ...
        $flujosCpd = CpdTareas::selectRaw('CpdID, CPD_Tareas.ID, SucursalID, CPD_Tareas.created_at')
            ...
            ->whereIn('CPD_Tareas.CpdTipoID',$tareasWip)
        ...
        return view('livewire.cpd.reportes.tiempos-wip');
    }
    ...
    public function updateDatatable($searchGerencia,$searchSucursal,$inputFechaInicio,$inputFechaFin): void
    {
        ...
        $this->emitTo('tiempos-wip', 'refreshComponent');
