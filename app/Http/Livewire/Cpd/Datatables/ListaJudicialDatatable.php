...
use App\Exports\cpd\exportJudicial;
...
class ListaJudicialDatatable extends DataTableComponent
{
    ...
    {
        $datos = CpdTareas::where('CPD_Tareas.CpdTipoID', 25);
        ...
        return [
            ...
            Column::make('Detalle','ID')
                ->format(function($value) {
                    $datos = CpdDatosTarea::where('TareaID',$value)->where('CampoID',190)->first();
                    return @$datos->Valor;
    ...
    {
        return Excel::download(new exportJudicial($this->searchMarca,$this->searchModelo,$this->inputFechaInicio,$this->inputFechaFin), 'reporteJudicial.xlsx');
    }
