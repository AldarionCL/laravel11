...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('SP_file_order_requests', function (Blueprint $table) {
            $table->id();
            $table->string('url');
            $table->unsignedBigInteger('ocOrderRequest_id');
            $table->foreign('ocOrderRequest_id')->references('id')->on('SP_oc_order_requests');
    ...
    {
        Schema::dropIfExists('SP_file_order_requests');
    }
};
