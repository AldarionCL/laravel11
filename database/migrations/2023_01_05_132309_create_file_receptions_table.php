...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('OC_file_receptions', function (Blueprint $table) {
            $table->id();
            $table->string('url');
            $table->unsignedBigInteger('reception_id');
            $table->foreign('reception_id')->references('id')->on('OC_receptions');
    ...
    {
        Schema::dropIfExists('OC_file_receptions');
    }
};
