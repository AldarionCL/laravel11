<x-app-layout>
                    ...
                    <div class="p-0 overflow-x-auto">
                        <div class="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 pb-0">
                            <div class="flex items-center">
                                <h4 class="card-title">@yield('title-header', 'Vehículos en CPD ') </h4>
                            </div>
                                ...
                                <div class="sm:-mx-6 lg:-mx-8">
                                    <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                                        <div class="overflow-x-auto">
                                            <livewire:cpd.componentes.modales.taller-grid : idSucursal="{{@$sucursal->ID}}" idCpd="{{@$idCpd}}"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script >
        $('#searchSucursal').on('change', function ( )
        {
            ...
            window.location.href = "/cpd/vehiculostaller/"+sucursal;
        });
    </script>
</x-app-layout>
