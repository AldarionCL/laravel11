            ...
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl rounded-2xl bg-clip-border">
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="overflow-x-auto" style="padding: 20px;">
                        <h2>Escanear QR</h2>
                        <p>Al escanear el QR de un vehículo , se comprobará los datos de este en los flujos de CPD,  si el vehículo está ingresado,  se le enviará al resumen del flujo para conocer su estado.</p>
