                            ...
                            <div id="alert-border-1"
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <div class="sm:w-1/2 md:w-1/4 lg:w-1/3 xl:w-1/3 text-sm font-medium">
                                        Fecha de egreso: <br><strong>{{($dyp->FechaEntrega != null) ? $dyp->FechaEntrega : $dyp->FechaEstimadaEntrega}}</strong>
                                    </div>
                                    <div class="sm:w-1/2 md:w-1/4 lg:w-1/3 xl:w-1/3 text-sm font-medium">
                            ...
                            <div class="flex flex-wrap p-2 rounded-lg border border-1 border-blue-200 p-2  items-center mb-4 text-gray-900 border-blue-300 ">
                                ...
                                <div class="w-full w-100">
                                    <div id="alert-border-1"
                                         ...
                                         role="alert">
                                        <livewire:dyp.componentes.tareas.referencia : idTarea="{{$tarea->ID}}"/>
                                    </div>
                                </div>

                                <div class="w-full w-100">
                                    @if($tarea->Estado == 'Abierto')
                                        @include('livewire.dyp.componentes.tareas.formulario')
                                        {{-- <livewire:dyp.componentes.tareas.formulario : idTarea="{{$tarea->ID}}"/>--}}
                                    @else
                                        <livewire:dyp.componentes.tareas.resuelto : idTarea="{{$tarea->ID}}"/>
                                    @endif
