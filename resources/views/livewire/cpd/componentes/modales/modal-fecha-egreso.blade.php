<form id="formCambiaEgreso" name="formCambiaEgreso"  method="get" action="{{route('cambiarFechaEgreso',[$idCpd])}}">
    ...
    <ul class="w-100 text-xs font-mediartinez Sotoum text-gray-900 bg-white border border-gray-200 rounded-lg">
        ...
        <li class="w-full px-4 py-2 border-b border-gray-200" style="z-index: 99">
            ...
            <li class="w-full px-4 py-2 border-b border-gray-200 " style="z-index: 99">
                <input type="datetime-local" required name="InputFechaEgreso" value="{{$cpd->FechaEstimadaEntrega}}"
