<form id="formLog" name="formLog"  method="get" action="{{route('creaLogCPD',[$idCpd])}}"
class="p-3">
    ...
    <ul class="w-100 text-xs font-mediartinez Sotoum text-gray-900 bg-white border border-gray-200 rounded-lg">
        <li class="w-full px-4 py-2 border-b border-gray-200 rounded-t-lg bg-gray-300"><span class="fa fa-user text-xs"> </span> Registro Log del flujo cpd</li>
