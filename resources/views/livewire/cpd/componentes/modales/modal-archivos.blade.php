...
class="p-3">
    ...
    <div class="flex flex-wrap w-full p-4">
        <form name="formArchivos" action="{{route('guardarArchivoscpd')}}" method="post" id="formArchivos" class="w-full p-2 border border-gray-200 rounded-lg m-0 shadow-md" enctype="multipart/form-data">
        <input type="hidden" name="idCpd" id="idCpd" value="{{$idCpd}}">
            @csrf
