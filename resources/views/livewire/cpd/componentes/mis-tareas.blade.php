            ...
            <table class="items-center min-w-full divide-y divide-gray-200 text-xs table-responsive">
                ...
                <tr>
                    <td class="text-center p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                            <a href="{{($tarea->Tipo->NombreTarea == 'Taller') ? route('tallercpd',[$tarea->ID]) : route('tareacpd',[$tarea->ID])}}" class="mb-0 font-semibold leading-tight text-xs">
                    ...
                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                        <a href="{{ route('flujocpd',[$tarea->CpdID]) }}" class="mb-0 font-semibold leading-tight text-xs">
                            <span class="fa fa-wrench"> {{$tarea->CpdID}} </span>
                        </a>
                    </td>
                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
