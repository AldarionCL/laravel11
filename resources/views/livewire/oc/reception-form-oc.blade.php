                                    ...
                                    <div
                                        ...
                                        <div class="flex-auto pt-6">
                                            <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                                                ...
                                                <span class="mb-2 leading-tight text-size-xs dark:text-white/80">Codigo : <span
                                ...
                                <div class="flex-auto pt-6">
                                    <div class="p-0 overflow-x-auto">
                                        <div
                                            class="items-center justify-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                                            <p class="leading-normal uppercase dark:text-white dark:opacity-60 text-size-sm">
                                                Detalle Solicitud de Compra {{ $ocPurchaseOrder->id }}
                                            </p>
                                            ...
                                            <div class="flex flex-wrap pt-6 pb-3">
                                                ...
                                                <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                    <div class="mb-4">
                                                        <label for="document"
                                                               class="inline-block mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80">Factura</label>
                                                        <input type="text" wire:key="document" wire:model.debounce.500ms="provider.name"
                                                ...
                                                <table
                                                    ...
                                                    @foreach( $ocDetailOrderRequest as $key => $item)

                                                        <tr>
                                                            <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                                {{ $item->ocProduct->ocSubCategory->ocCategory->name }}
                                                            </td>
                                                            <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                                {{ $item->ocProduct->sku }}
                                                            </td>
                                                            <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                                {{ $item->ocProduct->ocSubCategory->name }}
                                                            </td>
                                                            <td class="text-center p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                                {{ $item->amount }}
                                                            </td>
                                                            <td class="p-2 text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                                <div class="flex items-center justify-center" wire:key="data.{{ $key }}">
                                                                    <label for="brand"
                                                                           class="inline-block mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80" />

                                                                    <select wire:model="amount.{{ $key }}"
                                                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-size-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
