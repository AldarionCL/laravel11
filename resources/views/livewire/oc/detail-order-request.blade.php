                            ...
                            <div class="flex-auto pt-6">
                                <div class="p-0 overflow-x-auto">
                                    <div
                                        ...
                                        <p class="leading-normal uppercase dark:text-white dark:opacity-60 text-size-sm">
                                            Detalle Solicitud de Compra {{ $ocOrderRequest->id }}
                                        </p>

                                            @if( $ocOrderRequest->buyers_id === auth()->user()->ID && $ocOrderRequest->state === 1 )
                                                <a wire:click="cancel({{ $ocOrderRequest->id }})"
                                        ...
                                        @if( $ocOrderRequest->state === 8 )
                                            <a href="{{ route('recepcion-purchaseorder-controller.show',  $ocOrderRequest->id ) }}" class="inline-block px-8 py-2 mb-4 ml-auto font-bold leading-normal text-center text-white align-middle transition-all ease-in bg-blue-500 border-0 rounded-lg shadow-md cursor-pointer text-size-xs tracking-tight-rem hover:shadow-xs hover:-translate-y-px active:opacity-85">
                                                <i class="fa fa-search" aria-hidden="true"></i>
                                                Recepción Articulos
                                            </a>
                                        ...
                                        <div class="flex flex-wrap pt-6 pb-3">
                                            <table
                                                ...
                                                @foreach( $ocOrderRequest->ocDetailOrderRequest as $item)
