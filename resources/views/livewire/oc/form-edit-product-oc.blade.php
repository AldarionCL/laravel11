                                        ...
                                        <div class="flex flex-wrap">
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="ocSubCategory"
                                                        id="ocSubCategory"
                                                        wire:model="ocProduct.ocSubCategory_id"
                                                    ...
                                                    @error('ocProduct.ocSubCategory_id')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('ocProduct.ocSubCategory_id') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" name="product" wire:model="ocProduct.name"
                                                    ...
                                                    @error('ocProduct.name')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('ocProduct.name') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="costCenter"
                                                        id="costCenter"
                                                        wire:model="ocProduct.costCenter_id"
                                                    ...
                                                    @error('ocProduct.costCenter_id')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('ocProduct.costCenter_id') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <select name="measure" wire:model="ocProduct.measure_id"
                                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-size-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                                    ...
                                                    @error('ocProduct.measure_id')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('ocProduct.measure_id') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <select name="currency" wire:model="ocProduct.currency_id"
                                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-size-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                                        <option value="">Seleccione...</option>
                                                    ...
                                                    @error('ocProduct.currency_id')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('ocProduct.currency_id') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
