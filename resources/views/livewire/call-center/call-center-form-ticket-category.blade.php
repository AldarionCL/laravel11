                            ...
                            <div class="p-0 overflow-x-auto">
                                <div
                                    ...
                                    <p class="leading-normal uppercase dark:text-white dark:opacity-60 text-size-sm">
                                        Formulario Registro de Categorias Call Center</p>
                                        ...
                                        <div class="flex flex-wrap">
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" name="title" wire:model.debounce.500ms="callCenterCategory.name"
                                                    ...
                                                    @error('callCenterCategory.name')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('callCenterCategory.name') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
