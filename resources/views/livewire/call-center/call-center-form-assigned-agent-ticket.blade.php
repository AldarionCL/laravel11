                                        ...
                                        <div class="flex flex-wrap">
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    <label for="zone"
                                                        ...
                                                        de Negocio</label>
                                                    <select name="zone" wire:model="zone"
                                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-size-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                                        <option value="">Seleccione...</option>
                                                        @foreach($businessAreas as $businessArea)
                                                            <option
                                                                value="{{ $businessArea['ID'] }}">{{ $businessArea['name'] }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('zone')
                                                    <div class="text-red-500 text-xs">
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <select name="branch" wire:model="branch"
                                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-size-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                                        <option value="">Seleccione...</option>
                                                        @foreach($branches as $branch)
                                                            <option
                                                                value="{{ $branch->ID }}">{{ $branch->Sucursal }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('branch')
                                                    <div class="text-red-500 text-xs">
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    <label for="agent"
                                                           class="inline-block mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80">Agente</label>
                                                    <select name="agent" wire:model="agent"
                                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-size-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                                        <option value="">Seleccione...</option>
                                                        @foreach($agents as $agent)
                                                            <option
                                                                value="{{ $agent->ID }}">{{ $agent->Nombre }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('agent')
                                                    <div class="text-red-500 text-xs">
