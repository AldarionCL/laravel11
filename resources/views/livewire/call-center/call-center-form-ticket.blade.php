                        ...
                        <div class="flex-auto p-6">
                            <div class="p-0 overflow-x-auto">
                                <div class="items-center justify-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                                    <p class="leading-normal uppercase dark:text-white dark:opacity-60 text-size-sm">Formulario Registro de Ticket Call Center</p>
                                        ...
                                        <div class="flex flex-wrap ">
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <input id="title" name="title" type="text" wire:key="title" wire:model.debounce.500ms="callCenterTicket.title"
                                                    ...
                                                    @error('callCenterTicket.title')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('callCenterTicket.title') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="priority"
                                                        id="priority"
                                                        wire:model="callCenterTicket.priority"
                                                        :options="$priority"
                                                        value-field='id'
                                                        text-field='name'
                                                    ...
                                                    />
                                                    @error('callCenterTicket.priority')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('callCenterTicket.priority') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="category"
                                                        id="category"
                                                        wire:model="callCenterTicket.category"
                                                        :options="$categories"
                                                        value-field='id'
                                                        text-field='name'
                                                        placeholder="Seleccione ..."
                                                        ...
                                                        no-options="No hay datos"
                                                    />
                                                    @error('callCenterTicket.category')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('callCenterTicket.category') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="subCategory"
                                                        id="subCategory"
                                                        wire:model="callCenterTicket.subCategory"
                                                        ...
                                                        no-options="No hay datos"
                                                    />
                                                    @error('callCenterTicket.subCategory')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('callCenterTicket.subCategory') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="brand"
                                                        id="brand"
                                                        wire:model="callCenterTicket.management"
                                                        :options="$brands"
                                                        value-field='ID'
                                                        text-field='Gerencia'
                                                        placeholder="Seleccione ..."
                                                        ...
                                                        no-options="No hay datos"
                                                    />
                                                    @error('callCenterTicket.management')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('callCenterTicket.management') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="businessArea"
                                                        id="businessArea"
                                                        wire:model="callCenterTicket.zone"
                                                        ...
                                                        no-options="No hay datos"
                                                    />
                                                    @error('callCenterTicket.zone')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('callCenterTicket.zone') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="department"
                                                        id="department"
                                                        wire:model="callCenterTicket.department"
                                                        :options="$branches"
                                                        value-field='ID'
                                                        text-field='Sucursal'
                                                        placeholder="Seleccione ..."
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <textarea name="detail" wire:model.debounce.500ms="callCenterTicket.detail"
                                                              class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-size-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                                    </textarea>
                                                    @error('callCenterTicket.detail')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('callCenterTicket.detail') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
