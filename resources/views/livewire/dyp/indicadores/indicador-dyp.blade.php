        ...
        <div class="flex-auto p-4">
            <div class="flex flex-row -mx-3">
                <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                        <p class="mb-0 font-sans font-semibold leading-normal uppercase text-size-sm">Vehículos en Dyp<br>&nbsp;</p>
                        <h5 class="mb-2 font-bold" >{{$vehiculosDyp}}</h5>
    ...
    <div class="xs:w-1/2 sm:w-1/2 lg:w-1/4 m-2 relative flex flex-col min-w-25 break-words bg-white shadow-xl rounded-2xl bg-clip-border">
        <div class="flex-auto p-4">
            <div class="flex flex-row -mx-3">
                <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                        <p class="mb-0 font-sans font-semibold leading-normal uppercase text-size-sm">Vehículos en Taller<br>&nbsp;</p>
