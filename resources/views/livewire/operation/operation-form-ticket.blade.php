                    ...
                    <div class="p-0 overflow-x-auto">
                        <div class="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 pb-0">
                            <div class="flex items-center">
                                <p class="mb-0 dark:text-white/80">@yield('title-header', 'Operaciones') </p>

                                @if( in_array( auth()->user()->CargoID, array( 2, 4, 5, 6 ) ) )
                                    <a href="{{ route('operation.config') }}" class="inline-block px-8 py-2 mb-4 ml-auto font-bold leading-normal text-center text-white align-middle transition-all ease-in bg-blue-500 border-0 rounded-lg shadow-md cursor-pointer text-size-xs tracking-tight-rem hover:shadow-xs hover:-translate-y-px active:opacity-85">
                        ...
                        <div class="flex-auto p-6">
                            <div class="p-0 overflow-x-auto">
                                <div class="items-center justify-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                                    <p class="leading-normal uppercase dark:text-white dark:opacity-60 text-size-sm">Formulario Registro de Ticket Operaciones</p>
                                        ...
                                        <div class="flex flex-wrap ">
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <input id="title" name="title" type="text" wire:key="title" wire:model.debounce.500ms="operationTicket.title"
                                                    ...
                                                    @error('operationTicket.title')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('operationTicket.title') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="priority"
                                                        id="priority"
                                                        wire:model="operationTicket.priority"
                                                        :options="$priority"
                                                        value-field='id'
                                                        text-field='name'
                                                    ...
                                                    />
                                                    @error('operationTicket.priority')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('operationTicket.priority') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="category"
                                                        id="category"
                                                        wire:model="operationTicket.category"
                                                        :options="$categories"
                                                        value-field='id'
                                                        text-field='name'
                                                        placeholder="Seleccione ..."
                                                        ...
                                                        no-options="No hay datos"
                                                    />
                                                    @error('operationTicket.category')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('operationTicket.category') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="subCategory"
                                                        id="subCategory"
                                                        wire:model="operationTicket.subCategory"
                                                        ...
                                                        no-options="No hay datos"
                                                    />
                                                    @error('operationTicket.subCategory')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('operationTicket.subCategory') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="brand"
                                                        id="brand"
                                                        wire:model="operationTicket.management"
                                                        :options="$brands"
                                                        value-field='ID'
                                                        text-field='Gerencia'
                                                        placeholder="Seleccione ..."
                                                        ...
                                                        no-options="No hay datos"
                                                    />
                                                    @error('operationTicket.management')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('operationTicket.management') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="businessArea"
                                                        id="businessArea"
                                                        wire:model="operationTicket.zone"
                                                        ...
                                                        no-options="No hay datos"
                                                    />
                                                    @error('operationTicket.zone')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('operationTicket.zone') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        name="department"
                                                        id="department"
                                                        wire:model="operationTicket.department"
                                                        :options="$branches"
                                                        value-field='ID'
                                                        text-field='Sucursal'
                                                        placeholder="Seleccione ..."
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <textarea name="detail" wire:model.debounce.500ms="operationTicket.detail"
                                                              class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-size-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                                    </textarea>
                                                    @error('operationTicket.detail')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('operationTicket.detail') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
