                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal uppercase dark:text-white dark:opacity-60 text-size-xs">Total de Tickets</p>
                                    <h5 class="mb-2 font-bold dark:text-white" countTo="23980">{{ $amount }}</h5>
                ...
                <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal uppercase dark:text-white dark:opacity-60 text-size-xs">Ticket en Proceso</p>
                ...
                <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal uppercase dark:text-white dark:opacity-60 text-size-xs">Ticket Cerrados</p>
                ...
                <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal uppercase dark:text-white dark:opacity-60 text-size-xs">Ticket Abiertos</p>
                    ...
                    <div class="p-0 overflow-x-auto">
                        <div class="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 pb-0">
                            <div class="flex items-center">
                                <p class="mb-0 dark:text-white/80">@yield('title-header', 'Ticket') </p>

                                @if( in_array( auth()->user()->CargoID, array( 2, 4, 5, 6 ) ) )
                                    <a href="{{ route('ticket.config') }}" class="inline-block px-8 py-2 mb-4 ml-auto font-bold leading-normal text-center text-white align-middle transition-all ease-in bg-blue-500 border-0 rounded-lg shadow-md cursor-pointer text-size-xs tracking-tight-rem hover:shadow-xs hover:-translate-y-px active:opacity-85">
                        ...
                        <div class="flex-auto p-6">
                            <div class="p-0 overflow-x-auto">
                                <div class="items-center justify-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                                    <p class="leading-normal uppercase dark:text-white dark:opacity-60 text-size-xs">Formulario Registro de Ticket</p>
                                        ...
                                        <div class="flex flex-wrap ">
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <input id="title" name="title" type="text" wire:key="title" wire:model.debounce.500ms="ticket.title"
                                                           class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-size-xs leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none"/>
                                                    @error('ticket.title')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('ticket.title') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            {{--<div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        ...
                                                        :searchable="true"
                                                        class="form-select text-size-xs"
                                                        no-options="No hay datos"
                                                    />
                                                    @error('ticket.priority')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('ticket.priority') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>--}}
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <x-simple-select
                                                        ...
                                                        no-options="No hay datos"
                                                    />
                                                    @error('ticket.subCategory')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('ticket.subCategory') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    <label for="brand"
                                                           class="inline-block mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80">Marca - Gerencia</label>

                                                    <x-simple-select
                                                        name="brand"
                                                        id="brand"
                                                        wire:model="ticket.management"
                                                        :options="$brands"
                                                        value-field='ID'
                                                        text-field='Gerencia'
                                                        placeholder="Seleccione ..."
                                                    ...
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('ticket.management') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-12 md:flex-0">
                                                <div class="mb-4">
                                                    <label for="detail"
                                                           class="inline-block mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80">Identificador (<small>N° Venta, N° Ot, Factura, etc.</small>)</label>
                                                    <input id="identificador" name="identificador" type="text" wire:key="Identificador" wire:model.debounce.500ms="identificador"
                                                           class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-size-xs leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none"/>
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-12 md:flex-0">
                                                <div class="mb-4">
                                                    ...
                                                    <textarea name="detail" wire:model.debounce.500ms="ticket.detail"
                                                              class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-size-xs leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                                    </textarea>
                                                    @error('ticket.detail')
                                                    <div class="text-red-500 text-xs">
                                                        {{ $errors->first('ticket.detail') }}
                                                    </div>
                                                    @enderror
                                                </div>
                                            </div>
