<form action="{{route('guardarSiniestro',[$idTdrive])}}" id="guardarCSiniestro">
    ...
    <ul class="w-100 text-xs font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
        <li class="w-full px-4 py-2 border-b border-gray-200 rounded-t-lg dark:border-gray-600 bg-gray-300">
            <span class="fa fa-wrench text-xs"> </span> Datos Siniestro
        </li>
        <li class="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600"><strong>Magnitud Daño: </strong>
            <x-simple-select
                name="inputMagnitud"
                id="inputMagnitud"
        ...
        <li class="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600"><strong>Tipo Cliente: </strong>
            <x-simple-select
        ...
        <li class="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600"><strong>Compañía Seguro: </strong>
            <x-simple-select
                name="inputCiaSeguro"
                id="inputCiaSeguro"
        ...
        <li class="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600">Número OT: <input type="text" name="Ot_principal" wire:model="inputOT" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></li>
        <li class="w-full px-4 py-2 rounded-b-lg">Número Siniestro: <input type="text" name="NumeroSiniestro" wire:model="inputSiniestro" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></li>
    </ul>
