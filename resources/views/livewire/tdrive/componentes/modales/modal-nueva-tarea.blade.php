<form id="formCreaTarea" name="formCreaTarea"  method="get" action="{{route('creaTareaTDRIVE',[$idTdrive])}}">
    ...
    <ul class="w-100 text-xs font-mediartinez Sotoum text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
        <li class="w-full px-4 py-2 border-b border-gray-200 rounded-t-lg dark:border-gray-600 bg-gray-300"><span class="fa fa-user text-xs"> </span> Crear Nueva tarea </li>
        ...
        @foreach($tareas as $tarea)
            <li class="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600 @if($tieneAsignacion && $tarea->ID == 1) text-gray-500 @endif" style="z-index: 99">
                <div class="flex">
                    <div class="w-2/3">
