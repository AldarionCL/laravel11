<form id="formCambiaEgreso" name="formCambiaEgreso"  method="get" action="{{route('cambiarFechaEgresotdrive',[$idTdrive])}}">
    ...
    <ul class="w-100 text-xs font-mediartinez Sotoum text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
        <li class="w-full px-4 py-2 border-b border-gray-200 rounded-t-lg dark:border-gray-600 bg-gray-300"><span class="fa fa-user text-xs"> </span> Cambiar Fecha estimada de Egreso</li>
        <li class="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600" style="z-index: 99">
            ...
            <li class="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600 " style="z-index: 99">
                <input type="datetime-local" required name="InputFechaEgreso" value="{{$tdrive->FechaEstimadaEntrega}}"
