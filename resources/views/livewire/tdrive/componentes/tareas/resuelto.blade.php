<div class="w-100 ">
    <div id="alert-border-1" class="p-2 mb-4 text-gray-900 border-t-4 shadow-md border-green-300 bg-green-50 dark:text-white/60 dark:bg-gray-700 dark:border-green-500" role="alert">
        <div class="text-sm">
                    ...
                    @foreach($tarea->Datos as $datos)
                        <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 mb-4">
                            <div class="border border-light mb-3 p-2 border-gray-300">
                                <label
                                    class="border-b-2 border-blue-300 block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{@$datos->Campos->Campo}}</label>
                ...
                <div class="flex flex-wrap w-full">
                    @foreach($tarea->Archivos as $datos)
                        <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 mb-4">
                            <div class="border border-light mb-3 p-2 border-gray-300">
                                <label
                                    class="border-b-2 border-blue-300 block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{$datos->inputName}}</label>
