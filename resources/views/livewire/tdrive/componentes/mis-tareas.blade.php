<div class="relative flex flex-col w-full min-w-0 mb-0 break-words bg-white border-0 border-transparent border-solid shadow-xl rounded-2xl bg-clip-border dark:bg-blue-950 dark:text-gray-50">
    <div class="p-6 pb-0 mb-0 bg-white rounded-t-2xl dark:bg-blue-950 dark:text-gray-50">

    </div>
    <div class="flex-auto px-0 pt-0 pb-2">
        <div class="p-0 overflow-x-auto">
            <table class="items-center min-w-full divide-y divide-gray-200 dark:divide-none text-xs table-responsive">
                ...
                <tr class="px-6 py-3 pl-2 font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                    ...
                    <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">DyP</th>
                ...
                <tr>
                    <td class="text-center p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                            <a href="{{($tarea->Tipo->NombreTarea == 'Taller') ? route('tallertdrive',[$tarea->ID]) : route('tareatdrive',[$tarea->ID])}}" class="mb-0 font-semibold leading-tight text-xs">
                    ...
                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                        <a href="{{ route('flujotdrive',[$tarea->TdriveID]) }}" class="mb-0 font-semibold leading-tight text-xs">
                            <span class="fa fa-wrench"> {{$tarea->TdriveID}} </span>
                        </a>
                    </td>
                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
